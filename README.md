...
When I worked at Thomson Reutures, I acted as global Devops function leader. I am responsible for design and implement the CI/CD pipeline to deploy our product to AWS. We have several projects, some implmented CI/CD pipeline by using jenkins, some are using gitlab, also have projects that use codepiple in AWS. so I am quite familiar with CI/CD
